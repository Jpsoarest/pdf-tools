...
export default function PDFParaWebP() {
  ...
  const handleConvert = async () => {
    ...
    try {
      const response = await apiPost('/pdf-to-webp', formData);

      if (!response.ok) throw new Error('Erro ao converter PDF para WebP');

      const pages = parseInt(response.headers.get('X-Pages-Converted') || '0');
      setPagesConverted(pages);
      setSuccess(true);

      await saveResponseFiles(response, `convertido_${file.name.replace('.pdf', '')}.webp`);
    } catch (err) {
  ...
  return (
    <>
      ...
      {loading && <LoadingSpinner message="Convertendo PDF para imagens WebP…" />}
      ...
      <div className="page-root">
        <div className="page-inner">
          <nav className="breadcrumb">
            <a href="/">Início</a>
            <span>/</span>
            <span className="breadcrumb-current">PDF para WebP</span>
          </nav>
          ...
          <div className="page-header">
            ...
            <h1 className="page-title">PDF para WebP</h1>
            <p className="page-subtitle">Converta cada página do seu PDF em imagens WebP — o formato mais leve para web.</p>
          </div>
            ...
            {success && (
              <div className="success-box">
                ...
                <p className="success-p">
                  {pagesConverted} {pagesConverted === 1 ? 'página convertida' : 'páginas convertidas'} para WebP.
                  <br />
          ...
          <div className="features-mini">
            {[
              { e: '🗜️', t: 'Menor tamanho', d: 'Arquivos muito mais leves que JPG ou PNG' },
