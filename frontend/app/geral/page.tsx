  ...
  return (
    <>
      <style>{`
        ...
        .module-gate-title {
          color: var(--text-primary);
          font: 800 clamp(28px, 4vw, 44px) var(--font-display);
          line-height: 1.05;
          margin: 0;
        }
        .module-gate-copy {
        ...
        .module-card.general {
          ...
          justify-content: space-between;
          background:
            linear-gradient(135deg, rgba(99,102,241,.1), transparent 45%),
            var(--card-bg);
        }
        .module-card.oficio {
          display: grid;
          ...
          background: #10263d;
          border-color: rgba(214,163,113,0.36);
          color: #fff7ef;
        }
        .module-logo-panel {
          min-height: 250px;
          ...
          display: grid;
          place-items: center;
          border-right: 1px solid rgba(214,163,113,0.22);
        }
        .module-logo-panel img {
          width: min(210px, 76%);
          aspect-ratio: 1;
          object-fit: cover;
          border-radius: 18px;
          box-shadow: 0 24px 50px rgba(4,15,27,.38);
        }
        .module-oficio-content {
          padding: 28px;
          display: flex;
          flex-direction: column;
          justify-content: space-between;
          gap: 22px;
          background:
            linear-gradient(140deg, rgba(214,163,113,.2), transparent 48%),
            #10263d;
        }
        .module-eyebrow {
          display: inline-flex;
          ...
          letter-spacing: 1px;
          text-transform: uppercase;
          background: rgba(214,163,113,0.16);
          color: #e5bd93;
        }
        .module-name {
          margin: 16px 0 8px;
          font: 800 clamp(24px, 3vw, 34px) var(--font-display);
          line-height: 1.04;
        }
        .module-desc {
          color: inherit;
        ...
        @media (max-width: 768px) {
          .module-gate { padding: 36px 16px 8px; }
          .module-gate-head { display: block; }
          .module-gate-copy { margin-top: 10px; }
          .module-grid { grid-template-columns: 1fr; }
          .module-card.oficio { grid-template-columns: 1fr; }
          .module-logo-panel { min-height: 180px; border-right: 0; border-bottom: 1px solid rgba(214,163,113,0.22); }
      ...
      <div className="home2-root">
        <section className="module-gate">
          <div className="module-gate-head">
            <div>
              <div className="module-gate-kicker">Escolha o modulo</div>
              <h1 className="module-gate-title">PDF Tools em duas experiencias</h1>
            </div>
            <p className="module-gate-copy">
              Use a versao geral com todas as ferramentas ou entre no acesso resumido do 4o Oficio,
              focado nas rotinas mais usadas.
            </p>
          </div>

          <div className="module-grid">
            <Link href="/4oficio" className="module-card oficio">
              <div className="module-logo-panel">
                <img src="/logo.png" alt="Logo 4o Oficio" />
              </div>
              <div className="module-oficio-content">
                <div>
                  <span className="module-eyebrow">Acesso resumido</span>
                  <h2 className="module-name">4o Oficio</h2>
                  <p className="module-desc">
                    Interface direta para mesclar, editar e reordenar PDFs com a identidade visual da marca.
                  </p>
                </div>
                <div>
                  ...
                  <span className="module-enter" style={{ marginTop: 18 }}>Entrar no 4o Oficio</span>
                </div>
              </div>
            </Link>

            <a href="#acesso-geral" className="module-card general">
              <div>
                <span className="module-eyebrow">Completo</span>
                <h2 className="module-name">Acesso geral</h2>
                <p className="module-desc">
                  Todas as ferramentas para PDF, imagem, XML e utilidades, mantendo o fluxo atual da aplicacao.
                </p>
              </div>
              <div>
                <div className="module-actions">
                ...
                <span className="module-enter" style={{ marginTop: 18 }}>Acessar geral</span>
              </div>
            </a>
          </div>
        </section>

        <section className="h2-hero" id="acesso-geral">
